...
import 'package:mel_store/ui/views/product_details/product_details_view.dart'
    as _i4;
import 'package:mel_store/ui/views/startup/startup_view.dart' as _i3;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i4.ProductDetailsView: (data) {
      final args = data.getArgs<ProductDetailsViewArguments>(nullOk: false);
      return _i5.MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i4.ProductDetailsView(key: args.key, product: args.product),
        settings: data,
      );
    },
  };
